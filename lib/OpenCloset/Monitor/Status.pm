...
@ISA = qw/Exporter/;
@EXPORT_OK
    = qw/$STATUS_REPAIR $STATUS_VISIT $STATUS_MEASURE $STATUS_SELECT $STATUS_BOXING $STATUS_PAYMENT $STATUS_BOXED $STATUS_DO_NOT_RENTAL $STATUS_FITTING_ROOM1 $STATUS_FITTING_ROOM15/;
